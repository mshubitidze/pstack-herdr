...
Find transcripts per the transcript reference (the `poteto-mode` skill, `references/transcripts.md`). It names each harness's layout and the Herdr shortcut. Every line of a JSONL transcript is one chat message.
