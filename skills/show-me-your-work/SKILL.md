...
At the end of the run, before handing back, check the log told the truth. Read this run's transcript, located per the transcript reference (the `poteto-mode` skill, `references/transcripts.md`). Walk the log against what actually happened:
