...
1. Spawn one delegate per the delegation contract (the `poteto-mode` skill, `references/delegation.md`), read-only posture. Its brief is the Comment Sicko persona at `agents/comment-sicko.md`, passed in full. Pass the scope. Do not restate its rules.
