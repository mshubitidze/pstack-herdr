...
- The wake mechanism is your harness's own, not a pstack skill. Under Claude Code that is `/loop`. The [Autonomous run playbook](../../skills/poteto-mode/playbooks/autonomous-run.md) uses it to re-check the finish condition on events or a heartbeat.
